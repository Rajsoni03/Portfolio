...
function send(a) { $.ajax({ type: "POST", url: "email.php", data: a, cache: !1 }).done(function() { hideContactConfirmationContainer(), positionContactConfirmationContainer(), setTimeout("showContactConfirmationContainer(4)", 200), clearAllInputField() }).fail(function() { hideContactConfirmationContainer(), positionContactConfirmationContainer(), setTimeout("showContactConfirmationContainer(3)", 200) }) }
